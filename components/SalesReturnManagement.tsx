...
import { Modal, ConfirmationModal, PlusCircleIcon, DeleteIcon, EditIcon, PrintIcon, PdfIcon, ViewIcon, WhatsAppIcon, FormattedNumber, ChevronDownIcon, ArchiveIcon, WarningIcon, SwitchHorizontalIcon, BarcodeIcon } from './Shared';
    ...
    const handlePrint = (ret: SalesReturn) => {
        ...
        printWindow.document.write(`
            ...
            <body onload="window.print(); window.close();">
                ...
                <table>
                    <thead><tr><th style="width: 40px;">م</th><th>الصنف</th><th style="width: 70px;">الكمية</th><th style="width: 100px;">السعر</th><th style="width: 120px;">إجمالي</th></tr></thead>
