...
export interface CustomerReceipt { id: number; date: string; customerId: number; treasuryId: number; amount: number; notes: string; paymentMethod: 'cash' | 'check' | 'discount'; createdAt?: string; createdBy?: string; lastModifiedAt?: string; lastModifiedBy?: string; }
...
export interface SupplierPayment { id: number; date: string; supplierId: number; treasuryId: number; amount: number; notes: string; paymentMethod: 'cash' | 'check' | 'discount'; createdAt?: string; createdBy?: string; lastModifiedAt?: string; lastModifiedBy?: string; }
export interface SalesInvoiceItem { itemId: number; quantity: number; price: number; }
...
export interface SalesReturnItem { itemId: number; quantity: number; price: number; }
...
export interface PurchaseInvoiceItem { itemId: number; quantity: number; price: number; }
...
export interface PurchaseReturnItem { itemId: number; quantity: number; price: number; }
